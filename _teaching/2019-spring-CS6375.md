...
|11 | Mar 25 (mo) |  Ensemble Methods: Boosting (continued) <br> [Ensemble Methods: Gradient Boosting](https://gkunapuli.github.io/files/cs6375/13-GradientBoosting.pdf) | [Friedman, 99](https://statweb.stanford.edu/~jhf/ftp/trebst.pdf); <br> [Mason et al., 99](http://maths.dur.ac.uk/~dma6kp/pdf/face_recognition/Boosting/Mason99AnyboostLong.pdf); <br> [Visualizing Gradient Boosting](http://arogozhnikov.github.io/2016/06/24/gradient_boosting_explained.html); <br> [Tong He's Presentation on XGBoost](https://www.youtube.com/watch?v=ufHo8vbk6g4)    |    |
|   | Mar 27 (we) |  Ensemble Methods: Gradient Boosting (continued)  |    |  **HW 3 Due** <br> **HW4 Out**  |
|12 | Apr 1 (mo) |    |    |    |
|   | Apr 3 (we) |    |    |    |
|13 | Apr 8 (mo) |    |    |    |
