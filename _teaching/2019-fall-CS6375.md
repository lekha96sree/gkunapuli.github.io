...
permalink: /teaching/2019-fall-CS6375
venue: "JSOM 1.217"
date: 2019-08-01
location: "UT Dallas"
semester: "Fall 2019"
...
Course Overview
======
**Class Hours**: Tu/Th 8:30–9:45am <br> 
**Class Room**: JSOM 1.217 <br>
...
**Tentative list of topics that will be covered** (please see the previous offerings of this course for more information): Linear regression, Perceptron, Decision Trees, Support Vector Machines, Nearest Neighbor Methods, Na\:ive Bayes, Logistic Regression, Ensemble Methods (bagging, boosting, gradient boosting), Dimensionality Reduction, Clustering, Neural Networks \& Deep Learning and Reinforcement Learning. <br>

In addition, we will also cover practical aspects of machine learning: representation, feature selection, model selection and evaluation. <br>
...
Grading
======
* 40%, Homework Problem Sets/Programming Assignments (5, each 8%)
* 30%, Mid-term Exam
* 30%, Final Exam
