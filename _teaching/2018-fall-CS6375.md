...
|    | Sep 20 (th) | [Machine Learning Practice](https://gkunapuli.github.io/files/cs6375/08-MachineLearningPractice.pdf) <br> _pre-processing, model selection, cross validation, imbalanced data sets, missing data_ <br>| [Kotsiantis et al., 2006](https://pdfs.semanticscholar.org/c640/1e515a58fc36c37fc97e3b0cb18ce4682743.pdf) |   |
...
| 7  | Oct 2 (tu) | Ensemble Methods |  | **PA1 Due**  |
|    | Oct 4 (th) | Mid-Term Prep |   |   |
| 8  | Oct 9 (tu) | **In-class Mid-Term Exam** |  |   |
|    | Oct 11 (th) | Ensemble Methods (continued)  |  | **PA2 out** |
| 9  | Oct 16 (tu) | Principal Components Analysis  |  |   |
|    | Oct 18 (th) | Linear Discriminant Analysis |  |   |
| 10 | Oct 23 (tu) | Clustering |  |   |
|    | Oct 25 (th) | Clustering (continued)   |  | **PA2 due**  |
| 11 | Oct 30 (tu) | Neural Networks|  | **HW2 out**  |
|    | Nov 01 (th) | Neural Networks (continued)  |  |  |
| 12 | Nov 06 (tu) | Deep Learning |  |    |
|    | Nov 08 (th) | Deep Learning (continued) | **HW2 due** |  |
| 13 | Nov 13 (tu) | Hidden Markov Models |  | **PA3 Out**  |
