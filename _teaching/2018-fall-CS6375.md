...
| 11 | Oct 30 (tu) |[Clustering](https://gkunapuli.github.io/files/cs6375/15-Clustering.pdf) (continued) <br> _Slides updated to include Gaussian Mixture Models_  | **PA2 due** <br> **HW2 out**  |
|    | Nov 01 (th) | Neural Networks  |  |  |
| 12 | Nov 06 (tu) | Deep Learning |  |    |
|    | Nov 08 (th) | Deep Learning (continued) |  |  |
| 13 | Nov 13 (tu) | Hidden Markov Models |  | **HW2 due**, **PA3 Out**  |
