...
Office Hours:  Tue and Thu 1pm-2pm, ECSS 2.104 A1 <br>
...
| 4  | Sep 11 (tu) | [Support Vector Machines](https://gkunapuli.github.io/files/cs6375/06-SupportVectorMachines.pdf)  |  [Andrew Ng's Lecture Notes, Part I](http://cs229.stanford.edu/notes/cs229-notes-all/cs229-notes3.pdf);<br> Bishop, Ch. 7; <br> Barber, Ch. 17.5; <br> Shalev-Shwartz & Ben-David, Ch. 15 | **HW1 Due, PA1 Out**  |
|    | Sep 13 (th) | [Support Vector Machines](https://gkunapuli.github.io/files/cs6375/06-SupportVectorMachines.pdf) (continued) |  |   |
| 5  | Sep 18 (tu) | Machine Learning Theory<br> _VC Dimension, PAC bounds_ <br> _Bias-variance tradeoff_  | [Andrew Ng's Lecture Notes](http://cs229.stanford.edu/notes/cs229-notes4.pdf); <br> Shalev-Shwartz & Ben-David, Ch. 3-6  |   |
|    | Sep 20 (th) | Machine Learning Practice <br> _pre-processing, model selection, cross validation, imbalanced data sets, missing data_ <br>|  |  **PA1 Due**  |
