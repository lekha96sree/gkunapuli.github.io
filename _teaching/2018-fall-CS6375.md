...
|    | Sep 06 (th) | [Nearest Neighbor Methods](https://gkunapuli.github.io/files/cs6375/05-NearestNeighborMethods.pdf) | Bishop, Ch. 14.4; <br> [Daum\`e III, Ch. 3](http://ciml.info/dl/v0_99/ciml-v0_99-ch03.pdf) |   |
| 4  | Sep 11 (tu) | Support Vector Machines  |  | **HW1 Due, PA1 Out**  |
|    | Sep 13 (th) | Support Vector Machines (continued) |  |   |
| 5  | Sep 18 (tu) | From Machine Learning Theory...  |  | Bias-variance theory, PAC bounds  |
|    | Sep 20 (th) | ...to Machine Learning Practice |  |  cross validation, imbalanced <br> data sets, missing data <br> **PA1 Due**  |
