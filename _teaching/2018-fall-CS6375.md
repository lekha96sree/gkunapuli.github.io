...
| 2  | Aug 28 (tu) | Perceptron |  |   |
|    | Aug 30 (th) | Support Vector Machines |  |   |
| 3  | Sep 04 (tu) | Support Vector Machines (continued) |  |   |
|    | Sep 06 (th) | Naive Bayes & Logistic Regression |  |   |
| 4  | Sep 11 (tu) | Decision Trees |  |   |
|    | Sep 13 (th) | k-nearest Neighbor |  |   |
| 5  | Sep 18 (tu) | From Machine Learning Theory...  |  | Bias-variance theory, PAC bounds  |
|    | Sep 20 (th) | ...to Machine Learning Practice |  |  cross validation, imbalanced \ data sets, missing data |
| 6  | Sep 25 (tu) | Ensemble Methods: Bagging & Boosting |  |   |
|    | Sep 27 (th) | Ensemble Methods: Gradient Boosting |  |   |
| 7  | Oct 2 (tu) | Clustering |  |   |
|    | Oct 4 (th) | Clustering (continued) |  |   |
| 8  | Oct 9 (tu) | **In-class Mid-Term Exam** |  |   |
|    | Oct 11 (th) | Gaussian Mixture Models |  |   |
| 9  | Oct 16 (tu) | Hidden Markov Models |  |   |
|    | Oct 18 (th) | Bayesian Networks |  |   |
| 10 | Oct 23 (tu) | Principal Components Analysis |  |   |
|    | Oct 25 (th) | Linear Discriminant Analysis  |  |   |
| 11 | Oct 30 (tu) | Neural Networks |  |   |
|    | Nov 01 (th) | Deep Learning |  |   |
| 12 | Nov 06 (tu) | Deep Learning (continued) |  |   |
|    | Nov 08 (th) | Deep Learning |  |   |
| 13 | Nov 13 (tu) | Deep Learning (continued) |  |   |
|    | Nov 15 (th) | Deep Learning |  |   |
| 14 | Nov 20 (tu) | _Fall/Thanksgiving Break_ |  |   |
|    | Nov 22 (th) |_Fall/Thanksgiving Break_ |  |   |
| 15 | Nov 27 (tu) | Reinforcement Learning |  |   |
|    | Nov 29 (th) | Reinforcement Learning (continued) |  |   |
| 16 | Dec 4 (tu) | Collaborative Filtering |  |   |
|    | Dec 6 (th) | Course Summary/Final Exam Prep |  |   |
