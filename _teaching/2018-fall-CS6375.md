...
| 5  | Sep 18 (tu) | Machine Learning Theory<br> _VC Dimension, PAC bounds_ <br> _Bias-variance tradeoff, No Free Lunch_  | [Andrew Ng's Lecture Notes](http://cs229.stanford.edu/notes/cs229-notes4.pdf); <br> Shalev-Shwartz & Ben-David, Ch. 3-6  |   |
|    | Sep 20 (th) | Machine Learning Practice |  |  cross validation, imbalanced <br> data sets, missing data <br> **PA1 Due**  |
