...
|    | Sep 20 (th) | [Machine Learning Practice](https://gkunapuli.github.io/files/cs6375/07-MachineLearningPractice.pdf) <br> _pre-processing, model selection, cross validation, imbalanced data sets, missing data_ <br>|  |   |
