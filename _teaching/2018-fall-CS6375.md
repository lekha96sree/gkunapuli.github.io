...
|    | Oct 11 (th) | Clustering (continued) |  |   |
| 9  | Oct 16 (tu) | Gaussian Mixture Models |  |   |
|    | Oct 18 (th) | Hidden Markov Models |  |   |
| 10 | Oct 23 (tu) | Bayesian Networks |  |   |
|    | Oct 25 (th) | Principal Components Analysis   |  |   |
| 11 | Oct 30 (tu) | Linear Discriminant Analysis |  |   |
|    | Nov 01 (th) | Neural Networks  |  |  |
| 12 | Nov 06 (tu) | Deep Learning  |  |  Boltzmann Machines <br> (and Markov Random Fields)  |
|    | Nov 08 (th) | Deep Learning (continued) |  | Convolutional Neural Networks  |
| 13 | Nov 13 (tu) | Representation Learning |  |   |
|    | Nov 15 (th) | Collaborative Filtering |  |   |
