...
Python Resources
----
The programming assignments will require coding in **Python** and will primarily use [scikit-learn](http://scikit-learn.org/stable/) to explore various machine-learning algorithms. If you need a quick introduction to Python, here are some books **available online, free for personal use**.
